...
class com_phocaseoInstallerScript
{
    protected $extension 	= 'com_phocaseo';
	protected $updatetext 	= 'COM_PHOCASEO_UPDATE_TEXT';
	protected $installtext 	= 'COM_PHOCASEO_INSTALL_TEXT';
	protected $versiontext	= 'COM_PHOCASEO_VERSION';
	protected $extensiontext= 'COM_PHOCASEO';
	protected $configuretext= 'COM_PHOCASEO_CONFIGURE';
